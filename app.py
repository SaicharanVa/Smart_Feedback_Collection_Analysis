...
def export_csv():
    ...
    writer.writerow(['ID', 'Name', 'Type', 'Text', 'Rating', 'Sentiment', 'Score', 'Image', 'Timestamp'])
...
def export_pdf():
    ...
    feedback_data = [['ID', 'Name', 'Type', 'Rating', 'Sentiment', 'Image']]
    ...
    feedback_table = Table(feedback_data, colWidths=[0.5*inch, 1.5*inch, 1.5*inch, 0.8*inch, 1*inch, 0.7*inch])
